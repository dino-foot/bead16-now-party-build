...
export const DEFAULT_TURN_TIME = 15; // seconds [default: 60 seconds]
export const DEFAULT_LAST_STAND_MOVE = 50; // to trigger draw if both players reach this number of moves without a winner
export const DUMMY_PLAYER_TIME_MS = 12000; // 10 seconds only 1 player then trigger dummy multiplayer
