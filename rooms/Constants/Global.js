...
export const DRAW_REQUEST_BEADS_THRESHOLD = 6; // player has only 6 beads left can request draw | debug with 15 beads
export const DUMMY_PLAYER_TIME_MS = 10000; // 8 seconds only 1 player then trigger dummy multiplayer
